...
<div class="row">
    <div class="col-xl-10">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">{{ isset($data) ? 'Edit' : 'Add' }} Delivery Line</h4>
                <form action="{{ route('delivery-lins-mapping.store') }}" method="post" name="form" id="form"
                            ...
                            <table id="datatable" class="table table-bordered dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select id="delivery_staff_id"data-delivery-line-id='{{ $line->id }}'name="delivery_staff_id[]" class="form-select " disabled>
