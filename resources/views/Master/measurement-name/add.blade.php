        ...
        <div class="col-xl-10">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4">{{ isset($data) ? 'Edit' : 'Add' }} Measurement Name</h4>
                    <form action="{{ route('measurement.store') }}" method="post" name="form" id="form"
...
@section('script')
    <script>
        $(document).ready(function() {
            ...
            $('#Measurement').addClass('mm-active');
        });
    </script>
@endsection
